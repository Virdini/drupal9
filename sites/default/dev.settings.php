 ...
 * filename is 'sites/default/dev.settings.php'. Then, go to the bottom of
 * 'sites/default/settings.php' and uncomment the commented lines that mention
 * 'dev.settings.php'.
 *
 * If you are using a site name in the path, such as 'sites/example.com', copy
 * this file to 'sites/example.com/dev.settings.php', and uncomment the lines
 ...
 */
$settings['container_yamls'][] = DRUPAL_ROOT . '/sites/virdini.development.services.yml';
